...
const BookingDetail = () => {
  ...
  const downloadBookingDetailsAsPDF = () => {
    ...
    doc.text("Contact us: support@yourcompany.com", 14, y + 30);
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-4xl font-semibold mb-4">{booking.tool.tool_title}</h1>
      <div className="flex mb-4">
        ...
        <div className="w-1/2">
          ...
          <p className="text-md text-[#6A9C89] mb-4">
            {booking.tool.tool_description}
          </p>
