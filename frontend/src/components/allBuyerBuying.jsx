  ...
  return (
    ...
    <AdminHeader/>
      <div className="crop-selling-table mx-auto p-4">
        <h1 className="text-3xl  text-gray-800 mb-6  pt-5 pti-bold">
          Crop Buying Details
        </h1>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <div ref={componentsRef}>
              {/* Invoice details to be included only in the PDF */}
              <div className="text-center only-print">
                <h2 className="text-xl font-semibold pt-3 mb-2">
                  Invoice for Crop Buying Details
                </h2>
              </div>
              <hr className="only-print border-1 pb-3 border-gray-800" />
              ...
              {/* The table to be included in the PDF */}
